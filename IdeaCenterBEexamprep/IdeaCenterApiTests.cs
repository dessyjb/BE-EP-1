...
using IdeaCenterBEexamprep.Models;




namespace IdeaCenterBEexamprep
{
    [TestFixture]
    public class IdeaCenterApiTests
    {
        ...
        private const string StaticToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..HlCv1tzmYuE-p1EZd4Z0APfeWtjU1HcMKl1kKEevSlE";

        private const string LoginEmail = "Desi123@tester.com";
        private const string LoginPassword = "12341234";
        ...
        public void CreateIdea_WithRequiredFields_ShouldReturnSuccess()
        {
            ...
            {
                Title = "Test Idea",
                Description = "This is a test idea created during API testing.",
                Url = ""
            };
        ...
        public void GetAllIdeas_ShouldReturnListOfIdeas()
        {
            ...
            lastCreatedIdeaId = responseItems.Last().Id;
        ...
        public void EditExistingIdea_ShouldReturnSuccess()
        {
            var editRequest = new IdeaDTO
            {
              ...
              Description = "This is an updated test idea created during API testing.",
              Url = ""
            };
